...
public class ManageItemsFormController {
    ...
    private void loadAllItems() {
        ...
        try {
            /*Get all items*/
            final ArrayList<ItemDTO> allCustomer = itemBO.getAllItem();
            for (ItemDTO itm : allCustomer) {
                tblItems.getItems().add(new ItemTM(itm.getCode(), itm.getDescription(),itm.getUnitPrice() ,itm.getQtyOnHand()));
            }
    ...
    public void btnDelete_OnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            itemBO.deleteItem(code);// Deleted
