 ...
 private CustomerBo customerBo=(CustomerBo) BOFactory.getInstance().getBO(BOFactory.BOType.CUSTOMER);
    ...
    private void loadAllCustomers() {
        ...
        try {
          ...
          ArrayList<CustomerDTO> customerTMS= customerBo.getAllCustomer();
            for (CustomerDTO c : customerTMS) {
    ...
    boolean existCustomer(String id) throws SQLException, ClassNotFoundException {
       return new CustomerDAOImpl().exist(id);
    }
    ...
    public void btnDelete_OnAction(ActionEvent actionEvent) {
        ...
        try {
           ...
           customerBo.deleteCustomer(id); // Delete Customer DB
